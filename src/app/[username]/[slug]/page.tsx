...
import { LoaderCircle, Globe, MessageCircle, Send, AlertTriangle } from "lucide-react";
...
import { getPublicReportBySlug, type Report } from "@/services/reportService";
...
export default function PublicReportPage() {
  ...
  useEffect(() => {
    ...
    const fetchPublicReport = async () => {
        try {
            const foundReport = await getPublicReportBySlug(username, slug);
            if (foundReport) {
                setReport(foundReport);
                initiateChatWithWelcome(foundReport);
            } else {
                setError("This report is either private or does not exist. Please check the link.");
            }
        } catch (e: any) {
